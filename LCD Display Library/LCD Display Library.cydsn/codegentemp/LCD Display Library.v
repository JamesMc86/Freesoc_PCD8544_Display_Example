// ======================================================================
// LCD Display Library.v generated from TopDesign.cysch
// 05/12/2013 at 14:30
...
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_40"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_40\B_SPI_Master_v2_40.v"
`endif
...
module top ;
	...
	wire [4:0] tmpOE__LCD_Interface_net;
	wire [4:0] tmpFB_4__LCD_Interface_net;
	wire [4:0] tmpIO_4__LCD_Interface_net;
	wire [0:0] tmpINTERRUPT_0__LCD_Interface_net;
	electrical [0:0] tmpSIOVREF__LCD_Interface_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .width(5))
		LCD_Interface
		 (.oe(tmpOE__LCD_Interface_net),
		  .y({Net_71, Net_53, Net_29, Net_28, Net_25}),
		  .fb({tmpFB_4__LCD_Interface_net[4:0]}),
		  .io({tmpIO_4__LCD_Interface_net[4:0]}),
		  .siovref(tmpSIOVREF__LCD_Interface_net),
		  .interrupt({tmpINTERRUPT_0__LCD_Interface_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD_Interface_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{5'b11111} : {5'b11111};

    CyControlReg_v1_70 Data_CMD_Sel (
        .control_1(Net_62),
        .control_2(Net_63),
        .control_3(Net_64),
        .control_0(Net_53),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Data_CMD_Sel.Bit0Mode = 0;
    defparam Data_CMD_Sel.Bit1Mode = 0;
    defparam Data_CMD_Sel.Bit2Mode = 0;
    defparam Data_CMD_Sel.Bit3Mode = 0;
    defparam Data_CMD_Sel.Bit4Mode = 0;
    defparam Data_CMD_Sel.Bit5Mode = 0;
    defparam Data_CMD_Sel.Bit6Mode = 0;
    defparam Data_CMD_Sel.Bit7Mode = 0;
    defparam Data_CMD_Sel.BitValue = 0;
    defparam Data_CMD_Sel.BusDisplay = 0;
    defparam Data_CMD_Sel.ExtrReset = 0;
    defparam Data_CMD_Sel.NumOutputs = 1;

    assign Net_54 = 1'h0;

    CyControlReg_v1_70 LCD_RST (
        .control_1(Net_90),
        .control_2(Net_91),
        .control_3(Net_92),
        .control_0(Net_71),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LCD_RST.Bit0Mode = 0;
    defparam LCD_RST.Bit1Mode = 0;
    defparam LCD_RST.Bit2Mode = 0;
    defparam LCD_RST.Bit3Mode = 0;
    defparam LCD_RST.Bit4Mode = 0;
    defparam LCD_RST.Bit5Mode = 0;
    defparam LCD_RST.Bit6Mode = 0;
    defparam LCD_RST.Bit7Mode = 0;
    defparam LCD_RST.BitValue = 0;
    defparam LCD_RST.BusDisplay = 0;
    defparam LCD_RST.ExtrReset = 0;
    defparam LCD_RST.NumOutputs = 1;
